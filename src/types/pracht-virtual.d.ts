// Vendored from @pracht/vite-plugin's virtual.d.ts — the published package
// ships only dist/ and omits this file, so npm installs cannot type the
// virtual modules. Remove once upstream publishes it.
